  ...
  return (
    <section aria-label="Da una stanza a tutto il resto" className="bg-paper-lines bg-paper-100 text-ink-900">
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-9 sm:px-10 sm:py-14 lg:py-20">
        ...
        {/* Riga propria sotto i 6 KPI, centrata sull'intera larghezza della
            sezione — non un settimo elemento affiancato agli altri nella
            stessa fila. Stessa anatomia/tipografia (valore + etichetta) di
            uno stat, solo posizione diversa. mt-8/sm:mt-10 riprende il
            ritmo verticale già usato sopra (il blocco a due colonne prima
            della fascia KPI usa lo stesso mt-8). Il "valore" è un codice
            decorativo senza significato — aria-hidden, non va letto da
            uno screen reader — mentre kicker e frase sotto restano
            contenuto vero. */}
        <Reveal delayMs={420} className="mt-8 text-center sm:mt-10">
          {/* ✳︎ (U+2733 + variation selector U+FE0E) è lo stesso fix del
              ...
              il selettore non fa danno se risultasse superfluo. Ж è una
              lettera cirillica (non un simbolo/dingbat): quei blocchi non
              hanno una resa emoji alternativa, nessun selettore
              necessario. */}
